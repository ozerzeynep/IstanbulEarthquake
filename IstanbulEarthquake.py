# -*- coding: utf-8 -*-
"""RahvaMakale.ipynb adlı not defterinin kopyası adlı not defterinin kopyası

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1-DUxnfwFXrVLcAsnNrnmEWvy5i0t75Ch
"""
...
training_time1 = end_train_time - start_train_time                   #LINEAR REGRESSION(1)
...
testing_time1 = end_test_time - start_test_time
...
print(f"Training R^2 Score: {train_r2_lr}")
print("-----------------------------------------------------")
print(f"Testing Time: {testing_time1} seconds")
print(f"Testing MSE: {test_mse_lr}")
print(f"Testing MAE: {test_mae_lr}")
print(f"Testing R^2 Score: {test_r2_lr}")
...
train_mse_ro = mean_squared_error(y_train, y_train_pred)
train_mae_ro = mean_absolute_error(y_train, y_train_pred)
train_r2_ro = r2_score(y_train, y_train_pred)

start_test_time = time.time()
y_test_pred = rf.predict(x_test_scaled)
end_test_time = time.time()
testing_time2 = end_test_time - start_test_time

test_mse_ro = mean_squared_error(y_test, y_test_pred)
test_mae_ro = mean_absolute_error(y_test, y_test_pred)
test_r2_ro = r2_score(y_test, y_test_pred)

print(f"Training Time: {training_time2} seconds")
print(f"Training MSE: {train_mse_ro}")
print(f"Training MAE: {train_mae_ro}")
print(f"Training R^2 Score: {train_r2_ro}")
print("--------------------------------------------")
print(f"Testing Time: {testing_time2} seconds")
print(f"Testing MSE: {test_mse_ro}")
print(f"Testing MAE: {test_mae_ro}")
print(f"Testing R^2 Score: {test_r2_ro}")
...
train_mse_svr = mean_squared_error(y_train, y_train_pred)
train_mae_svr = mean_absolute_error(y_train, y_train_pred)
train_r2_svr = r2_score(y_train, y_train_pred)

start_test_time = time.time()
y_test_pred = best_svr.predict(x_test_scaled)
end_test_time = time.time()
testing_time3 = end_test_time - start_test_time

test_mse_svr = mean_squared_error(y_test, y_test_pred)
test_mae_svr = mean_absolute_error(y_test, y_test_pred)
test_r2_svr = r2_score(y_test, y_test_pred)

print(f"Training Time: {training_time3} seconds")
print(f"Training MSE: {train_mse_svr}")
print(f"Training MAE: {train_mae_svr}")
print(f"Training R^2 Score: {train_r2_svr}")
print("--------------------------------------------------")
print(f"Testing Time: {testing_time3} seconds")
print(f"Testing MSE: {test_mse_svr}")
print(f"Testing MAE: {test_mae_svr}")
print(f"Testing R^2 Score: {test_r2_svr}")
print("---------------------------------------------------")
...
train_mse_cat = mean_squared_error(y_train, y_train_pred)
train_mae_cat = mean_absolute_error(y_train, y_train_pred)
train_r2_cat = r2_score(y_train, y_train_pred)

# Test veri seti üzerinde tahminlerin yapılması ve test süresinin ölçülmesi
start_test_time = time.time()
y_test_pred = best_catboost.predict(x_test_scaled)
end_test_time = time.time()
testing_time7 = end_test_time - start_test_time

# Test veri seti için metriklerin hesaplanması
test_mse_cat = mean_squared_error(y_test, y_test_pred)
test_mae_cat = mean_absolute_error(y_test, y_test_pred)
test_r2_cat = r2_score(y_test, y_test_pred)

print(f"Training Time: {training_time7} seconds")
print(f"Training MSE: {train_mse_cat}")
print(f"Training MAE: {train_mae_cat}")
print(f"Training R^2 Score: {train_r2_cat}")
print("-----------------------------------------------")
print(f"Testing Time: {testing_time7} seconds")
...
train_mse_xg = mean_squared_error(y_train, y_train_pred)
train_mae_xg = mean_absolute_error(y_train, y_train_pred)
train_r2_xg = r2_score(y_train, y_train_pred)

start_test_time = time.time()
y_test_pred = best_xgb.predict(x_test_scaled)
end_test_time = time.time()
testing_time4 = end_test_time - start_test_time

test_mse_xg = mean_squared_error(y_test, y_test_pred)
test_mae_xg = mean_absolute_error(y_test, y_test_pred)
test_r2_xg = r2_score(y_test, y_test_pred)

print(f"Training Time: {training_time4} seconds")
print(f"Training MSE: {train_mse_xg}")
print(f"Training MAE: {train_mae_xg}")
print(f"Training R^2 Score: {train_r2_xg}")
print("----------------------------------------------------")
print(f"Testing Time: {testing_time4} seconds")
print(f"Testing MSE: {test_mse_xg}")
print(f"Testing MAE: {test_mae_xg}")
print(f"Testing R^2 Score: {test_r2_xg}")
print("---------------------------------------------------")
print(f"Best parameters: {grid_search.best_params_}")
...
train_mse_dc = mean_squared_error(y_train, y_train_pred)
train_mae_dc = mean_absolute_error(y_train, y_train_pred)
train_r2_dc = r2_score(y_train, y_train_pred)

start_test_time = time.time()
y_test_pred = best_tree.predict(x_test_scaled)
end_test_time = time.time()
testing_time5 = end_test_time - start_test_time

test_mse_dc = mean_squared_error(y_test, y_test_pred)
test_mae_dc = mean_absolute_error(y_test, y_test_pred)
test_r2_dc = r2_score(y_test, y_test_pred)

print(f"Training Time: {training_time5} seconds")
print(f"Training MSE: {train_mse_dc}")
print(f"Training MAE: {train_mae_dc}")
print(f"Training R^2 Score: {train_r2_dc}")
print("----------------------------------------")
print(f"Testing Time: {testing_time5} seconds")
print(f"Testing MSE: {test_mse_dc}")
print(f"Testing MAE: {test_mae_dc}")
print(f"Testing R^2 Score: {test_r2_dc}")
print("---------------------------------------")
...
train_mse_ex = mean_squared_error(y_train, y_train_pred)
train_mae_ex = mean_absolute_error(y_train, y_train_pred)
train_r2_ex = r2_score(y_train, y_train_pred)

start_test_time = time.time()
y_test_pred = best_extra_trees.predict(x_test_scaled)
end_test_time = time.time()
testing_time6 = end_test_time - start_test_time

test_mse_ex = mean_squared_error(y_test, y_test_pred)
test_mae_ex = mean_absolute_error(y_test, y_test_pred)
test_r2_ex = r2_score(y_test, y_test_pred)

print(f"Training Time: {training_time6} seconds")
print(f"Training MSE: {train_mse_ex}")
print(f"Training MAE: {train_mae_ex}")
print(f"Training R^2 Score: {train_r2_ex}")
print("--------------------------------------")
print(f"Testing Time: {testing_time6} seconds")
print(f"Testing MSE: {test_mse_ex}")
print(f"Testing MAE: {test_mae_ex}")
print(f"Testing R^2 Score: {test_r2_ex}")
print("----------------------------------------")
print(f"Selected Features: {selected_features}")
print(f"Best parameters: {random_search.best_params_}")
...
# 
# x_train_scaled = np.random.rand(100, 12)
# y_train = np.random.rand(100)
# 
# model_lr = lr.fit(x_train_scaled, y_train)
# 
# st.title('Deprem Can Kaybı Tahmini')
# st.write("Lütfen ilgili bilgileri giriniz:")
# 
# 
# ilce_adi = st.text_input("İlçe Adı")
# mahalle_adi = st.text_input("Mahalle Adı")
# cok_agir_hasarli_bina_sayisi = st.number_input("Çok Ağır Hasarlı Bina Sayısı", min_value=0)
# agir_hasarli_bina_sayisi = st.number_input("Ağır Hasarlı Bina Sayısı", min_value=0)
# orta_hasarli_bina_sayisi = st.number_input("Orta Hasarlı Bina Sayısı", min_value=0)
# hafif_hasarli_bina_sayisi = st.number_input("Hafif Hasarlı Bina Sayısı", min_value=0)
# agir_yarali_sayisi = st.number_input("Ağır Yaralı Sayısı", min_value=0)
# hastanede_tedavi_sayisi = st.number_input("Hastanede Tedavi Sayısı", min_value=0)
# hafif_yarali_sayisi = st.number_input("Hafif Yaralı Sayısı", min_value=0)
# dogalgaz_boru_hasari = st.number_input("Doğalgaz Boru Hasarı", min_value=0)
# icme_suyu_boru_hasari = st.number_input("İçme Suyu Boru Hasarı", min_value=0)
# atik_su_boru_hasari = st.number_input("Atık Su Boru Hasarı", min_value=0)
# gecici_barinma = st.number_input("Geçici Barınma", min_value=0)
# 
# user_input = np.array([[cok_agir_hasarli_bina_sayisi, agir_hasarli_bina_sayisi, orta_hasarli_bina_sayisi,
#                         hafif_hasarli_bina_sayisi, agir_yarali_sayisi, hastanede_tedavi_sayisi, hafif_yarali_sayisi,
#                         dogalgaz_boru_hasari, icme_suyu_boru_hasari, atik_su_boru_hasari, gecici_barinma]])
# 
# if st.button("Can Kaybı Tahmin Et"):
#     start_test_time = time.time()
...
#     st.write(f"Can Kaybı Tahmini: {prediction[0]:.2f}")
#     st.write(f"Test Süresi: {testing_time:.4f} saniye")
#
